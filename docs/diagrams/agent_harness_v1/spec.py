...
NODES = [
 ("n_cli","component.entry","<b>demo.js</b><br>CLI · 3 modes<br>", 64, 260, 128, 60),
 ("n_harness","component.service","<b>AgentHarness.run()</b><br>while(true)", 352, 260, 160, 60),
 ("n_agent","component.agent","<b>ResearchAgent.step()</b><br>3 phases", 624, 260, 160, 60),
 ("n_registry","component.service","<b>TOOL_REGISTRY</b><br>dispatch", 896, 260, 160, 60),
 ("n_tracer","component.service","<b>Tracer.log()</b><br>every iteration", 896, 356, 160, 56),
 ("n_tools","component.external","<b>4 tools</b><br>webSearch · readPage<br>noteFindings · synthesize", 1384, 260, 248, 60),
 ("n_mocks","component.mock","<b>MOCK corpora</b><br>MOCK_SEARCH_RESULTS<br>MOCK_PAGES — no network", 1384, 372, 248, 60),
 ("n_trace","component.artifact","<b>trace-&lt;runId&gt;.jsonl</b><br>tracer.js", 1384, 620, 248, 48),
 ("n_report","component.artifact","<b>report-&lt;runId&gt;.md</b><br>demo.js", 1384, 692, 248, 48),
 ("n_pm","component.service","<b>postmortem()</b><br>harness.js", 352, 512, 160, 56),
 ("n_dx","component.service","<b>diagnosePrimitives()</b><br>diagnosis.js", 560, 512, 176, 56),
 ("card_gates","card.invariant",
 "<b>STOP CONDITIONS — complete, in code order</b><br>"
 "1 ITERATION_CAP — checked BEFORE the step<br>"
 "2 AGENT_DONE · 3 COST_CAP · 4 CONVERGENCE<br>"
 "counter resets on a productive iteration<br>"
 "cost model $3 / $15 per 1M tokens", 832, 496, 424, 116),
 ("card_fail","card.failure",
 "<b>POSTMORTEM TAXONOMY — 8 patterns</b><br>"
 ...
 "<b>10 harness primitives, scored 0.0–1.0 · diagnosis.js</b><br>"
 "Instructions · Context Delivery · Context Management<br>"
 "Tool Interface · Execution Environment · Durable State …", 352, 624, 424, 104),
]
