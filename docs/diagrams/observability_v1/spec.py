...
ZONES = [
 ...
 ("z_write", "Phase 1 — write path (demo.js)", "boundary.functional",
 368, 192, 464, 136),
...
NODES = [
 ...
 "<b>demo.js — npm start</b><br>unlink DB first<br>simulate()<br>startDashboard()",
 64, 232, 200, 64),
 ("n_tracer", "component.agent",
 "<b>Tracer</b> tracer.js<br>DEAD — 0 new sites<br>Span.end() writes<br>camelCase keys",
 64, 336, 200, 64),

 ("n_sim", "component.mock",
 "<b>simulate()</b><br>simulator.js<br>500 reqs · 7 days<br>1-4 spans each",
 400, 232, 176, 64),
 ("n_store", "component.service",
 "<b>Store</b> store.js<br>WAL · FK on<br>only writer API<br>20 methods · 8 dead",
 624, 232, 176, 64),
 ("n_db", "component.artifact",
 "<b>observability.db</b><br>SQLite · 7 tables<br>6 ever written<br>wiped each run",
 848, 232, 176, 64),
 ("n_dash", "component.service",
 "<b>startDashboard()</b><br>dashboard.js<br>express · 13 routes<br>12 use store.db raw",
 1104, 232, 176, 64),

 ("n_inline", "component.service",
 "<b>inline drift check</b><br>simulator.js<br>pct change, not z<br>3 alerts, 1 agent",
 400, 408, 176, 64),
 ("n_cost", "component.service",
 "<b>CostTracker</b><br>costTracker.js<br>12 methods · 2 used<br>warn 80% block 100%",
 624, 408, 176, 64),
 ("n_qual", "component.service",
 "<b>QualityScorer</b><br>qualityScorer.js<br>8 methods · 0 used<br>hash+LCG, no judge",
 864, 408, 176, 64),
 ("n_drift", "component.service",
 "<b>DriftDetector</b><br>driftDetector.js<br>real z-score<br>5 metrics · 1 route",
 1104, 408, 176, 64),

 ("n_ui", "component.external",
 "<b>public/index.html</b> — browser<br>5 tabs · hand-rolled canvas<br>"
 "11 fetch() sites<br>KPI auto-refresh 10 s",
 1384, 232, 248, 64),

 ("n_stdout", "component.artifact",
 "<b>stdout summary</b><br>demo.js — traces · spans<br>quality scores · drift alerts<br>plus the URL, dashboard.js",
 1384, 552, 248, 64),

 ("card_drift", "card.primitive",
 "<b>DRIFT — injected in 4 places, detected by 2</b><br>"
 "INJECTED — simulator.js, one agent only<br>"
 " research-agent last 2 of 7 d<br>"
 " 1 prompt+completion tokens x1.4<br>"
 " 2 latency x1.6<br>"
 " 3 tool-call chance .30 -&gt; .55<br>"
 " 4 quality score -0.5<br>"
 "DETECTED TWICE, BY DIFFERENT MATH<br>"
 " A simulator.js — percent change<br>"
 " latency &gt;20% · tokens &gt;20%<br>"
 " quality drop &gt;0.2 · 3 alerts max<br>"
 " writes pct INTO the z_score column<br>"
 " runs on every npm start<br>"
 " B driftDetector.js — a real z-score<br>"
 " |z|&gt;=2 warn · |z|&gt;=3 critical<br>"
 " 5 metrics x each agent x model<br>"
 " runs only via dashboard.js",
 376, 520, 296, 248),

 ("card_wiring", "card.invariant",
 "<b>SIX CLASSES — every construction site</b><br>"
 "Store store.js<br>"
 " simulator.js · dashboard.js<br>"
 " 20 data methods, 8 with 0 callers<br>"
 "CostTracker costTracker.js<br>"
 " simulator.js · dashboard.js<br>"
 " 12 public, 2 called<br>"
 "QualityScorer qualityScorer.js<br>"
 " dashboard.js — then NEVER called<br>"
 "DriftDetector driftDetector.js<br>"
 " dashboard.js · runAllChecks<br>"
 "Tracer tracer.js<br>"
 " ZERO construction sites in the repo<br>"
 "Span · Trace tracer.js<br>"
 " reachable only via Tracer<br>"
 "metrics_snapshots store.js is the only<br>"
 ...
 " trace.latencyMs traces has none<br>"
 " trace.totalTokens total_tokens<br>"
 " trace.costCents total_cost (USD)<br>"
 " trace.timestamp started_at<br>"
 " span.durationMs latency_ms<br>"
 " span.tokens total_tokens<br>"
 " span.costCents cost<br>"
 " span.toolCalls tool_calls, a string<br>"
 " span.children parent_span_id, flat<br>"
 " alert.zScore z_score<br>"
 " data.metrics dashboard.js<br>"
 "Adapted in 2 places only — timeseries,<br>"
 "attribution. The rest are read raw.<br>"
 "GET /api/traces/:id — dashboard.js filters<br>"
 "trace_id; store.js has no such column.",
 976, 520, 304, 248),
]
...
EDGES = [
 ...
 [(1148, 360), (952, 360)]),
 ("e_cost", "n_dash", "n_cost", "1 route", "edge.call", (0.75, 1), (0.5, 0),
 [(1236, 392), (712, 392)]),
 ("e_drift", "n_dash", "n_drift", "1 route", "edge.call", (0.5, 1), (0.5, 0), []),
