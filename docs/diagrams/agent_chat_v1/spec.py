...
NODES = [
 ...
 "<b>Chat UI</b><br>SSE client · app.js<br>EventSource", 56, 264, 176, 64),
 ("n_inspector", "component.entry",
 "<b>Run Inspector</b><br>report-card modal<br>showTrace", 56, 400, 176, 64),

 # ── Server: front door + streams ──
 ("n_server", "component.service",
 "<b>Express server</b><br>routes · CSP · limits<br>server.js", 352, 264, 176, 64),
 ("n_streams", "component.service",
 "<b>StreamManager</b><br>buffer + SSE replay<br>streams.js", 352, 424, 176, 64),

 # ── Pipeline (functional boundary) ──
 ("n_guardrails", "component.service",
 "<b>Guardrails</b><br>block inject · redact<br>guardrails.js", 592, 264, 176, 64),
 ("n_agent", "component.agent",
 "<b>runAgent()</b><br>reason ≤8 → answer<br>agent.js", 844, 264, 176, 64),
 ("n_llm", "component.service",
 "<b>LLMAdapter</b><br>chat/stream · JSON-retry<br>llm.js", 1096, 264, 176, 64),
 ("n_observer", "component.service",
 "<b>AgentObserver</b><br>5 scores → report card<br>tracer.js", 592, 424, 176, 64),
 ("n_tools", "component.service",
 "<b>Tools · executeTool</b><br>wiki search/read · calc<br>tools.js", 1096, 424, 176, 64),

 # ── Upstream network ──
 ("n_providers", "component.external",
 "<b>LLM providers</b><br>Ollama NDJSON · NVIDIA/Gemini SSE<br>llm.js", 1384, 168, 248, 72),
 ("n_wiki", "component.external",
 "<b>Wikipedia API</b><br>opensearch + REST summary<br>tools.js", 1384, 288, 248, 64),

 # ── Persistence ──
 ("n_db", "component.artifact",
 "<b>SQLite · WAL + FTS5</b><br>threads · messages(tree) · runs<br>decisions · feedback · facts<br>db.js (shared store)",
 1384, 512, 248, 80),

 # ── Cards ──
 ("card_scores", "card.invariant",
 "<b>FIVE SCORES PER RUN · tracer.js end()</b><br>"
 "1 Tool ROI = used ÷ tool decisions<br>"
 "&nbsp;&nbsp;&nbsp;n-gram overlap ≥ 0.15 ⇒ used<br>"
 "2 Coherence = consec-thought terms<br>"
 "&nbsp;&nbsp;&nbsp;≥ 2 shared terms ⇒ coherent<br>"
 "3 Productivity: productive | wasted<br>"
 "&nbsp;&nbsp;&nbsp;respond OR result used ⇒ productive<br>"
 "4 Confidence signals (from thought)<br>"
 "&nbsp;&nbsp;&nbsp;hedging·confident·uncertain·<br>"
 "&nbsp;&nbsp;&nbsp;seeking_info·ready_to_answer<br>"
 "5 Strategy<br>"
 "&nbsp;&nbsp;&nbsp;direct·single_tool·multi_tool·iterative<br>"
 "→ persisted: agent_runs + decisions",
 344, 560, 296, 224),

 ("card_guard", "card.failure",
 "<b>GUARDRAILS — block in, redact both ways</b><br>"
 "scanInput()<br>"
 "&nbsp;&nbsp;16 injection regex → block<br>"
 "&nbsp;&nbsp;5 PII types redacted<br>"
 "&nbsp;&nbsp;&nbsp;card·ssn·email·phone·apikey<br>"
 "&nbsp;&nbsp;blocked ⇒ canned reply<br>"
 "scanOutput()<br>"
 "&nbsp;&nbsp;same 5 PII masked on answer<br>"
 "&nbsp;&nbsp;2 disclaimer patterns flagged<br>"
 "one audit_log row per scan",
 664, 560, 296, 160),

 ("card_limits", "card.primitive",
 "<b>PRODUCTION LIMITS — safe to expose publicly</b><br>"
 "rate/IP: 300 read · 20 write per min<br>"
 "20 concurrent runs → 503<br>"
 "message &gt; 8000 chars → 413<br>"
 "JSON body ≤ 64 kb<br>"
 "CSP + 5 security headers<br>"
 "graceful drain + WAL checkpoint",
 984, 560, 296, 136),
]
