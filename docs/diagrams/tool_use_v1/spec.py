...
NODES = [
 ...
 "<b>demo.js</b><br>npm run demo<br>3 parts", 64, 248, 128, 64),

 ("n_ask", "component.service",
 "<b>agent.ask(question)</b><br>retry loop · 4 tries<br>agent.js", 304, 248, 160, 64),

 ("n_llm", "component.agent",
 "<b>llm(messages) — mockLLM</b><br>19 patterns + default<br>agent.js · seam",
 520, 248, 176, 64),

 ("n_perm", "component.service",
 "<b>validateQuery()</b><br>3 tiers, deny-default<br>permissions.js", 776, 248, 176, 64),

 ("n_exec", "component.service",
 "<b>db.prepare(sql).all()</b><br>better-sqlite3 · timed<br>agent.js", 1032, 248, 176, 64),

 ("n_cost", "component.service",
 "<b>estimateQueryCost()</b><br>EXPLAIN QUERY PLAN<br>permissions.js", 776, 368, 176, 56),

 ("n_fmt", "component.service",
 "<b>formatResult(rows)</b><br>table / scalar / meta<br>formatter.js", 1032, 368, 176, 56),

 ("n_dbmod", "component.service",
 "<b>database.js</b><br>openDatabase (WAL, FK on)<br>getSchemaContext"
 "<br>getAllowedTables", 1384, 260, 248, 72),

 ("n_db", "component.artifact",
 "<b>analytics.db</b><br>SQLite · users products<br>orders events · 15,020 rows"
 "<br>database.js · seeded", 1384, 372, 248, 72),

 ("n_out", "component.artifact",
 "<b>stdout — success</b><br>table + query metadata<br>demo.js", 1384, 612, 248, 56),

 ("n_deny", "component.artifact",
 "<b>stdout — refusal</b><br>PERMISSION DENIED<br>CONFIRMATION REQUIRED",
 1384, 684, 248, 56),

 ("card_gate", "card.invariant",
 "<b>validateQuery() — EVERY check, in code order · permissions.js</b><br>"
 "BLOCK 1 multiple statements ';' · 2 first keyword not SELECT<br>"
 "BLOCK 3 destructive keyword x14 · 4 metadata table x6<br>"
 "BLOCK 5 load_extension · 6 table not in allowedTables<br>"
 "BLOCK 7 subquery depth > 2 · 8 UNION + constant<br>"
 "CONFIRM 9 over 3 JOINs · 10 no WHERE clause (one result)<br>"
 "ALLOW fall-through only — first match wins; order is load-bearing",
 304, 496, 456, 112),

 ("card_deny", "card.failure",
 "<b>DENY LISTS — complete, in declaration order</b><br>"
 "destructive — INSERT UPDATE DELETE DROP ALTER CREATE<br>"
 "TRUNCATE REPLACE EXEC ATTACH DETACH PRAGMA GRANT REVOKE (14)<br>"
 "metadata — information_schema sqlite_master sqlite_schema<br>"
 "sqlite_temp_master pg_catalog pg_tables (6) · load_extension<br>"
 "allowedTables database.js — users products orders events (4)",
 304, 632, 456, 96),

 ("card_attempt", "card.primitive",
 "<b>ONE ask() ATTEMPT — 4 steps in code order · agent.js</b><br>"
 "1 llm(messages) — md fences + trailing ';' stripped<br>"
 "2 validateQuery(sql, allowedTables)<br>"
 " !allowed -> 'PERMISSION DENIED', return<br>"
 " needsConfirm and !autoConfirm -> return — never retried<br>"
 "3 estimateQueryCost(db, sql) — EXPLAIN QUERY PLAN<br>"
 "4 db.prepare(sql).all() — timed by performance.now()<br>"
 " on throw -> errors.push + retry prompt appended<br>"
 "<br>"
 "<b>4 ATTEMPTS MAX</b> — attempt = 0..maxRetries, default 3<br>"
 "exhausted -> 'Failed after N attempts' + error list<br>"
 "<br>"
 "<b>AgentResult envelope — 10 fields · agent.js</b><br>"
...
EDGES = [
 ...
 ("e_cost", "n_perm", "n_cost", "sql", "edge.call", (0.5, 1), (0.5, 0), []),
 ("e_fmt", "n_exec", "n_fmt", "rows", "edge.primary", (0.5, 1), (0.5, 0), []),
