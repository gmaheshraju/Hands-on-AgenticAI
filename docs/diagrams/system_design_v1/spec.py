...
NODES = [
 ("n_demo","component.entry","<b>demo.js:166</b><br>mock LLM + fixtures", 64, 236, 160, 64),
 ("n_live","component.entry","<b>review.js:87</b><br>real GitHub + LLM", 64, 380, 160, 64),
 ("n_react","component.service","<b>runReActLoop()</b><br>agent.js:157", 408, 252, 176, 64),
 ("n_tools","component.service","<b>Tool Registry</b><br>5 tools · tools.js:64", 688, 252, 176, 64),
 ("n_schema","component.service","<b>Schema · validate</b><br>schema.js:39", 968, 252, 176, 64),
 ("n_mockllm","component.mock","<b>Simulated LLM</b><br>8 scripted steps · :16", 408, 460, 176, 56),
 ("n_mockdata","component.mock","<b>Mock PR data</b><br>mock-data.js:5", 688, 460, 176, 56),
 ("n_github","component.external","<b>GitHub API</b><br>PR · diff · file · search · comment", 1368, 240, 248, 56),
 ("n_anthropic","component.external","<b>Anthropic API</b><br>review.js:26", 1368, 332, 248, 56),
 ("n_openai","component.external","<b>OpenAI API</b><br>review.js:59", 1368, 424, 248, 56),
 ...
 ("card_exit","card.invariant",
  ...
  "1 FINISH unparseable → retry message :197<br>"
  "2 FINISH valid → validate · dedupe · sort · return :208<br>"
  "3 unknown tool → error observation :234<br>"
  "4 stall xN identical → force-finish :262<br>"
  "5 neither FINISH nor ACTION → parse retry :284<br>"
  "6 maxIterations → empty output, cappedOut :295<br>"
  "<i>findings sort: bug → security → suggestion → nit · schema.js:138</i>", 408, 540, 456, 152),
]
...
EDGES = [
 ...
 ("e_tool","n_react","n_tools","tool.execute :248","edge.call",(1,0.5),(0,0.5),[]),
 ("e_val","n_react","n_schema","validate · dedupe · sort :219","edge.call",(0.75,1),(0.25,1),[(540,364),(1012,364)]),
 ("e_llm","n_react","n_mockllm","llmCall :184","edge.call",(0.5,1),(0.5,0),[]),
 ...
 ("e_out","n_schema","n_findings","return output :222","edge.artifact",(0.75,1),(0,0.5),[(1100,736)]),
]
