...
ZONES = [
 ("z_entry", "③ Entry — CLI", "boundary.datasource",
   40, 200, 196, 140),
 ("z_proc",  "① LLMGateway — request() orchestrator · gateway.js:32", "boundary.primary",
   300, 96, 1356, 396),
...
NODES = [
 ("n_demo", "component.entry",
  "<b>demo.js</b><br>CLI · 6 scenarios<br>main :15 · :144", 52, 236, 176, 64),

 # --- the 7-stage pipeline, left to right ---
 ("n_s1", "component.service",
  "<b>1 · Budget</b><br>CostTracker<br>checkBudget :38", 344, 236, 160, 64),
 ("n_s2", "component.service",
  "<b>2 · Rate limit</b><br>TokenBucket<br>check :46", 520, 236, 160, 64),
 ("n_s3", "component.service",
  "<b>3 · PII redact</b><br>pii.js<br>redactMessages :56", 696, 236, 160, 64),
 ("n_s4", "component.service",
  "<b>4 · Route</b><br>ModelRouter<br>route :69", 872, 236, 160, 64),
 ("n_s5", "component.service",
  "<b>5 · Middleware</b><br>use() chain :76<br>(empty by default)", 1048, 236, 160, 64),
 ("n_s6", "component.service",
  "<b>6 · Execute</b><br>+retry / failover<br>gateway :85 :114", 1224, 236, 160, 64),
 ("n_s7", "component.service",
  "<b>7 · Track</b><br>cost record + audit<br>gateway :88-97", 1400, 236, 160, 64),

 # --- gateway-internal dependency ---
 ("n_cb", "component.service",
  "<b>CircuitBreaker</b><br>per-provider gate<br>closed / open / half<br>circuitBreaker.js:26",
  1048, 400, 176, 64),

 # --- external surface (mocked) ---
 ("n_prov", "component.external",
  "<b>Provider handlers</b><br>anthropic · openai<br>· google — MOCK<br>demo.js:25-27",
  1064, 580, 176, 64),

 # --- observability sink ---
 ("n_obs", "component.artifact",
  "<b>AuditLog + dash</b><br>query / compliance<br>replayTrace :85<br>dashboard :177",
  1436, 580, 176, 64),

 # --- cards ---
 ("card_pii", "card.primitive",
  "<b>PII — 10 patterns, redacted before route</b><br>"
  "1 SSN :2   ·   2 CREDIT_CARD (Luhn) :3<br>"
  "3 EMAIL :4   ·   4 PHONE_US :5<br>"
  "5 PHONE_IN :6   ·   6 IP_ADDRESS :7<br>"
  "7 AWS_KEY :8   ·   8 API_KEY :9<br>"
  "9 AADHAAR :10   ·   10 PAN :11<br>"
  "Luhn-fail skipped, not redacted :35",
  40, 520, 300, 200),

 ("card_route", "card.invariant",
  "<b>ROUTING — 6 rungs, code order (router.js)</b><br>"
  "1 team → exact model    team_override :51<br>"
  "2 request.model set     explicit_model :58<br>"
  "3 custom rule           rule:&lt;name&gt; :65<br>"
  "4 complexity tier       complexity :74<br>"
  "5 fallback chain        fallback_chain :85<br>"
  "6 none left → all_providers_down :94<br>"
  "each rung gates on canRequest()",
  360, 520, 300, 200),

 ("card_audit", "card.invariant",
  "<b>AUDIT — 7 write sites, not 1 (README: 1)</b><br>"
  "1 budget block :40<br>"
  "2 rate-limit block :48<br>"
  "3 PII detected :60<br>"
  "4 no provider :71<br>"
  "5 middleware block :79<br>"
  "6 response ok :97<br>"
  "7 failover / retry :134<br>"
...
EDGES = [
 ...
 ("e_route_cb", "n_s4", "n_cb", "canRequest :53", "edge.call", (0.5, 1), (0.25, 0),
   [(952, 388), (1092, 388)]),
 ("e_exec_cb",  "n_s6", "n_cb", "record :129",    "edge.call", (0.5, 1), (0.75, 0),
   [(1304, 388), (1180, 388)]),

 # execute reaches the external providers
 ("e_exec_prov", "n_s6", "n_prov", "execute :128", "edge.primary", (0.75, 1), (0.5, 0),
   [(1344, 520), (1152, 520)]),
