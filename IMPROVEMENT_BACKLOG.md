...
- [ ] **FineTuningVsRag** decision tree: no long-context / prompt-caching branch — "just put it in the prompt and cache it" is now a real alternative to both RAG and fine-tuning and the tree never offers it.
