...
// Link-preview cards live in public/og/ and are generated by `npm run og`.
...
export const ROUTES = [
  ...
  },
  {
    ...
    description:
      'Chunking strategies, embedding models, hybrid search, reranking: building retrieval that works in production.',
  },
  {
    path: '/blog/llm-ops',
  ...
  },
  {
    ...
    description:
      'A decision framework for when to prompt engineer, when to retrieve, when to fine-tune, and when to combine them.',
  },
  {
  ...
  },
  {
    ...
    description:
      'Why one developer with AI can outbuild a team of twenty, and how engineers anywhere in the world are building products that compete with giants.',
  },
...
// Each post gets its own 1200x630 card; every other page uses the site default.
export function ogImageFor(route) {
  return route.path.startsWith('/blog/')
    ? `${SITE_URL}/og/${route.path.slice('/blog/'.length)}.png`
    : OG_IMAGE;
}
