...
export default function AiUxPatterns() {
  ...
  return (
    <div className="page-content">
      ...
      <div hidden={tab !== 0}><StreamingPanel /></div>
      <div hidden={tab !== 1}><ConfidencePanel /></div>
      <div hidden={tab !== 2}><HumanInTheLoopPanel /></div>
      <div hidden={tab !== 3}><ErrorStatesPanel /></div>
      <div hidden={tab !== 4}><TrustPatternsPanel /></div>
