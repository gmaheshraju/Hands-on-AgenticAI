...
export default function LlmOps() {
  ...
  return (
    <div className="page-content">
      ...
      <div hidden={tab !== 0}><ModelServingPanel /></div>
      <div hidden={tab !== 1}><CostEngineeringPanel /></div>
      <div hidden={tab !== 2}><LatencyReliabilityPanel /></div>
      <div hidden={tab !== 3}><MonitoringPanel /></div>
