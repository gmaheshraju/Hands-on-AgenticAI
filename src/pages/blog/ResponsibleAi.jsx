  ...
  return (
    <FadeIn>
      ...
      <Decision question="Fairness metrics: which one to use?">
        ...
        Simple to measure, simple to explain. But it can be unfair: if base rates genuinely differ (e.g.,
  ...
  return (
    <FadeIn>
      ...
      <Decision question="How to structure a red-team exercise">
        ...
        (3-5 security researchers for 2-3 days, ~$15-25K) catches creative attacks automated tools miss. Run it
        ...
        <p>Works at scale but noisy: 80%+ of reports are low-quality duplicates. Anthropic, OpenAI, and Google
      ...
      <Decision question="What to do with findings">
        ...
        <p>Backlog. Fix in next model update. But still add it to the eval suite; today's mild issue becomes
  ...
  return (
    <FadeIn>
      <SectionHead title="Model Cards & Documentation"
        desc="The documentation that responsible AI requires. Not bureaucracy, but your legal defense and your engineering contract with downstream consumers." />
  ...
  return (
    <FadeIn>
      <SectionHead title="Governance Frameworks"
        desc="How to operationalize responsible AI across an engineering organization. Systems, not documents." />
      ...
      <Decision question="AI review board: who and how?">
        ...
        The external ethicist prevents groupthink, because internal teams rationalize their own products. Budget
      ...
      <Insight tag="Key insight">
        Governance is not compliance theater. The test: if something goes wrong at 2am, can your team
