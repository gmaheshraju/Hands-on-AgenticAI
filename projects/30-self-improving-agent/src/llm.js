...
export class LLMAdapter {
  constructor(opts = {}) {
    this.providers = opts.providers || ['nvidia', 'ollama', 'gemini'];
    this.ollamaBaseUrl = opts.ollamaBaseUrl || 'http://localhost:11434';
    this.ollamaModel = opts.ollamaModel || DEFAULT_OLLAMA_MODEL;
    this.nvidiaApiKey = opts.nvidiaApiKey || process.env.NVIDIA_API_KEY;
    this.nvidiaModel = opts.nvidiaModel || DEFAULT_NVIDIA_MODEL;
    this.geminiApiKey = opts.geminiApiKey || process.env.GEMINI_API_KEY;
    this.geminiModel = opts.geminiModel || DEFAULT_GEMINI_MODEL;
